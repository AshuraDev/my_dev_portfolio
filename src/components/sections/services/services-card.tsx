...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, imageUrl }) => {
  return (
    <div className="relativ e overflow-hidden rounded-sm bg-card shadow-sm transition-all hover:shadow-2xl flex flex-col h-[450px] max-w-lg">
      ...
      <div className="p-4 flex flex-col flex-grow">
        <div className="flex items-center justify-between">
          <h3 className="text-base md:text-xl font-semibold text-primary">{title}</h3>
        </div>
